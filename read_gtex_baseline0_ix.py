# class to load clean GTEx data and baseline functional annotations by index
...
class Loader:
    ...
    def load_data(self, ix, load_annot):
        df_hsq = self.load_hsq()
        gene_id = df_hsq.index[ix]
        ...
        return gene_id, X_gtex, y_gtex_res_scaled, df_annot